---
title: Brightspace Help Center
description: A learner-first support surface for common Brightspace access and release-update questions.
icon: life-ring
layout:
  width: wide
---
...
<table data-view="cards">
  ...
  <tbody>
    <tr>
      <td><h3>:key:</h3></td>
      <td><strong>Log in to Brightspace</strong></td>
      <td>Find the right login page, understand SSO versus local login, and know when your institution must help.</td>
    ...
    <tr>
      ...
      <td><a href="subscribing-to-release-notes.md">subscribing-to-release-notes</a></td>
    </tr>
    <tr>
      <td><h3>:people_holding_hands:</h3></td>
      <td><strong>Know who owns support</strong></td>
...
{% hint style="warning" %}
Brightspace accounts, passwords, and institution access are typically managed by the customer's school or organization, not by D2L directly. That distinction should stay highly visible throughout the help experience.
{% endhint %}
